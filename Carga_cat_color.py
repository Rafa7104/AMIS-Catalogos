...
def replace_keys(row):
  new_key_assign = { 'ID' : 'id_color', 'VALOR' : 'descripcion', 'ESTATUS_ID' : 'estatus_color' }
...
#        default='gs://poc_amis')
  ...
  source = 'gs://'+bucnam+'/catalogos/cat_color.json'
...
#pd.options.display.max_rows = 10
  dfx = pd.DataFrame(df)
  dfs = dfx[['ID','VALOR','ESTATUS_ID']].astype(str).drop_duplicates()
